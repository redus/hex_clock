...
var send_settings = function() {
	Pebble.sendAppMessage(
			...
			"KEY_MONTH_ZERO": localStorage.getItem("KEY_MONTH_ZERO") === "0" ? 0 : 1,
			"KEY_DAY_ZERO": localStorage.getItem("KEY_DAY_ZERO") === "0"? 0 : 1,
			"KEY_BATTERY_ON": localStorage.getItem("KEY_BATTERY_ON") === "0" ? 0 : 1,
			"KEY_PERCENT_SIGN": localStorage.getItem("KEY_PERCENT_SIGN") === "0" ? 0 : 1,
			"KEY_WEEKDAY_ON": localStorage.getItem("KEY_WEEKDAY_ON") === "0" ? 0 : 1,
			"KEY_WEEKDAY_NAMED": localStorage.getItem("KEY_WEEKDAY_NAMED") === "0" ? 0 : 1,
			"KEY_WEEKDAY_START": localStorage.getItem("KEY_WEEKDAY_START") === "0" ? 0 : 1,
